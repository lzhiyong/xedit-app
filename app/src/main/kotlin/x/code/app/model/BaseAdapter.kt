...
class BaseListAdapter<T: Any>(
    ...
    // click callback
    var onItemClick: (BaseListAdapter<T>.(T) -> Unit)? = null
    // long click callback
    var onItemLongClick: (BaseListAdapter<T>.(T) -> Unit)? = null
...
class BaseAdapter<T: Any>(
    ...
    var onBindView: ((ViewHolder, T) -> Unit)? = null
    // click callback
    var onItemClick: (BaseAdapter<T>.(T) -> Unit)? = null
    // long click callback
    var onItemLongClick: (BaseAdapter<T>.(T) -> Unit)? = null
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            onItemClick?.invoke(this, datas[position])
        }
        
        // on long click callback
        holder.itemView.setOnLongClickListener {
            onItemLongClick?.invoke(this, datas[position])
            return@setOnLongClickListener true
        }
    }
