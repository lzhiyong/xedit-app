...
#define GET_POINTER(ctype, object) (ctype *)GET_FIELD(Long, object, _cat2(ctype, pointer))
...
typedef struct {
    ...
    jfieldID TSLanguage_pointer;
    jfieldID TSNode_context;
    jfieldID TSNode_id;
    jfieldID TSNode_tree;
    
    jfieldID TSParser_pointer;
    ...
    jfieldID TSTree_pointer;
    jfieldID TSTree_source;
    jfieldID TSTree_language;
    
    jfieldID TSTreeCursor_pointer;
    jfieldID TSTreeCursor_tree;
    
    jfieldID TSQuery_pointer;
    ...
    jfieldID TSLookaheadIterator_pointer;
    jfieldID UInt_data;
} JFieldCache;
...
static inline TSNode unmarshal_node(JNIEnv *env, jobject node) {
    ...
    jlong pointer = GET_FIELD(Long, tree, TSTree_pointer);
    
    return TSNode {
        .context = {context[0], context[1], context[2], context[3]},
        .id = reinterpret_cast<const void*>(id),
        .tree = reinterpret_cast<const TSTree*>(pointer)
    };
}
