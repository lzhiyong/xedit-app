...
class TSTree internal constructor(
     ...
     */
    fun copy() = TSTree(copy(pointer), source, language)
    ...
    override fun toString() = "TSTree(id=0x${pointer.toString(16)}, language=$language)"
    ...
    private companion object {
        @JvmStatic
        @CriticalNative
        private external fun copy(pointer: Long): Long
