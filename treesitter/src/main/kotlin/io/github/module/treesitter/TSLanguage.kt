 ...
 */
class TSLanguage (internal val pointer: Long) {
    /**
     ...
     * ```
     */
    constructor(name: String): this(grammar(name))
    
    init {
        if (pointer <= 0L) {
            throw IllegalArgumentException("Invalid language: $pointer")
        }
        checkVersion()
    }
    ...
    override operator fun equals(other: Any?) =
        this === other || (other is TSLanguage && pointer == other.pointer)

    override fun hashCode() = pointer.hashCode()

    override fun toString() = "TSLanguage(id=0x${pointer.toString(16)}, version=$version)"
    ...
    private companion object {
        ...
        @FastNative
        @JvmName("getGrammar")
        private external fun grammar(name: String): Long
    }
}
