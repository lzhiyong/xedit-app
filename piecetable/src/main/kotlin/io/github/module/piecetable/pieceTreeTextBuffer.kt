...
class PieceTreeTextBuffer(
    ...
    fun getSnapshotContent(preserveBOM: Boolean = false): String {
       val snapshot = createSnapshot(preserveBOM)
        val buffer = StringBuffer()
        // be careful with large text buffer, OutOfMemoryError
    ...
    fun substring(startOffset: Int, endOffset: Int=_pieceTree.getLength()): String {
        // note: the offset is not checked
