...
public abstract class DocumentFile(
    protected val mParent: DocumentFile?
) {
    companion object {
        ...
        fun createEmptyFile(name: String, uri: Uri): DocumentFile {
            return EmptyDocumentFile(name, uri)
        }      
     ...
     */
    public fun getParentFile(): DocumentFile? {
        return mParent
    }
    ...
    public fun getParent() = this.mParent
